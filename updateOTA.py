...
absPath = os.path.abspath(os.getcwd())+"\\OmniassistProyect"

if os.path.exists(absPath+"/OmniassistProyect.ino.esp32.bin"):
    os.remove(absPath+"/fw.bin")
    os.rename(absPath+"/OmniassistProyect.ino.esp32.bin", absPath+"/fw.bin")
